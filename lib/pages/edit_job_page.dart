...
class _EditJobPageState extends State<EditJobPage> {
  ...
  void initState() {
    super.initState();
    photoUrl = widget.job.photoUrl;
    _jobTitleController.text = widget.job.jobTitle;
    _detailsController.text = widget.job.details;
    _eligibiltyController.text = widget.job.eligibilty;
  ...
  void editJob() async {
    ...
    String res = await _crud.editJob(
    ...
    if (res == "success") {
      setState(() {
        _isLoading = false;
        showSnackBar(context, "تم التعديل بنجـاح");
